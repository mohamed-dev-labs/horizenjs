...
*   **امتداد VS Code**: لتعزيز إنتاجية المطور، يتوفر امتداد لـ VS Code يوفر مقتطفات (snippets) وإكمال تلقائي (auto-completion) للوظائف الرئيسية.
...
ابحث عن "Horizen.js Helper" في سوق امتدادات VS Code لتثبيت الامتداد. يوفر هذا الامتداد مقتطفات كود مفيدة مثل:

*   `hz-init`: لتهيئة `HorizenClient`.
*   `hz-req`: لإجراء طلب باستخدام `hzClient.request()`.
